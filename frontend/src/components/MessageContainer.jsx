...
const MessageContainer = () => {
    ...
    useEffect(() =>{
        socket.on("newMessage", (message) =>{
            ...
            if(!document.hasFocus()){ // make 2 tab => get messages when not focused on the tab
    ...
    useEffect(() =>{
        // not empty array and is the last msg from another user
        ...
        <Divider />
            ...
            {!loadingMessages && 
                messages.map( (message) =>(
                    ...
                    >
                    <Message messages = {message} ownMessage={currentUser._id === message.sender}/>
                    </Flex>
